...
using _04.Bank_System.Data;
using _04.Bank_System.Models;

namespace _04.Bank_System
{
    public class Program
    {
        ...
        private static void ListAccounts()
        {
            ...
            else
            {
                ...
                foreach (var sa in db.SavingAccounts.Where(a => a.Owner.Username == LoggedIn.Username)
                    .OrderBy(a => a.IBAN))
                {
            ...
            else
            {
                ...
                foreach (var ca in db.CheckingAccounts.Where(a => a.Owner.Username == LoggedIn.Username)
                    .OrderBy(a => a.IBAN))
                {
