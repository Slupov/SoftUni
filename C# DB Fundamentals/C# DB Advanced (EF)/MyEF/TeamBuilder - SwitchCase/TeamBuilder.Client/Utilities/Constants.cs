...
namespace TeamBuilder.Client.Utilities
{
    public static class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            public const string InviteNotFound = "Invite {0} is not found!";

            public const string NotPartOfTeam = "User {0} is not a member of {1}!";
            ...
            public const string InvalidStartDate = "Start date must be earlier than end date!";


            // Team error messages.
            public const string InvalidAcronym = "Acronym {0} not valid!";
            public const string TeamExists = "Team {0} exists!";
            public const string InvalidTeamName = "Team name {0} should be up to 25 characters long!";
        }
    }
}