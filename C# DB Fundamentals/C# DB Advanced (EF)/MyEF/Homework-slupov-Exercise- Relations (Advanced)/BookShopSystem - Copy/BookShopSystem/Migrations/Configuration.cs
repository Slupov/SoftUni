...
//            string[] authors = File.ReadAllLines("../../Import/authors.csv");
            string[] authors = File.ReadAllLines(@"c:\users\stoya\documents\visual studio 2017\Projects\BookShopSystem\BookShopSystem\Import\authors.csv");
        ...
        private static void SeedBooks(BookShopContext context)
        {
            ...
            string[] books = File.ReadAllLines(@"c:\users\stoya\documents\visual studio 2017\Projects\BookShopSystem\BookShopSystem\Import\books.csv");
        ...
        private static void SeedCategories(BookShopContext context)
        {
            ...
            string[] categories = File.ReadAllLines(@"c:\users\stoya\documents\visual studio 2017\Projects\BookShopSystem\BookShopSystem\Import\categories.csv");
